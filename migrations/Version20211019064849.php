 ...
 */
final class Version20211019064849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coaching ADD image_b VARCHAR(255) DEFAULT NULL, ADD image_c VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coaching DROP image_b, DROP image_c');
    }
}
